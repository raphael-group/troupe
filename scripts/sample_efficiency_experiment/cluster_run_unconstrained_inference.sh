...
# ....
# Example usage:
#   `bash scripts/sample_efficiency_experiment/cluster_run_unconstrained_inference.sh`
...
experiment_name=sample_efficiency_experiment/rate_matrix_$rate_matrix/unconstrained
